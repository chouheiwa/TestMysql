...
extension String.Encoding {
    ...
    static func CFEncoding(_ encoding: CFStringEncodings) -> String.Encoding {
        return String.Encoding(rawValue: CFStringConvertEncodingToNSStringEncoding(CFStringEncoding(encoding.rawValue)))
    }

    static let big5: String.Encoding = String.Encoding.CFEncoding(CFStringEncodings.big5)

//    static let cp850: String.Encoding = String.Encoding.CFEncoding(CFStringEncodings.)

//    static let dec8: String.Encoding = String.Encoding.CFEncoding(CFStringEncodings.)

//    static let hp8: String.Encoding = String.Encoding.CFEncoding(CFStringEncodings.)

    static let GB2312: String.Encoding = String.Encoding.CFEncoding(CFStringEncodings.GB_2312_80)

    static let GBK: String.Encoding = String.Encoding.CFEncoding(CFStringEncodings.GBK_95)

    static let GB18030: String.Encoding = String.Encoding.CFEncoding(CFStringEncodings.GB_18030_2000)
}
...
extension CharacterSet {
    ...
    var encoding: String.Encoding? {
        ...
        case .koi8u:
            return String.Encoding.windowsCP1252
        case .gb2312:
            return String.Encoding.GB2312
        case .greek:
            return nil
        case .cp1250:
            return String.Encoding.windowsCP1250
        case .gbk:
            return String.Encoding.GBK
        case .latin5:
            return nil
        case .armscii8:
            return nil
        ...
        case .eucjpms:
            return nil
        case .gb18030:
            return String.Encoding.GB18030
        case .utf8mb4:
            return String.Encoding.utf8
        }
    }
